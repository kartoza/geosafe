...
<qgis version="2.18.15" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    <edittype widgetv2type="TextEdit" name="parent_name">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="area_id">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="last_updated">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    ...
    <edittype widgetv2type="TextEdit" name="city_name">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  </edittypes>
  ...
  <customproperties>
    ...
    <property key="labeling/shapeFillColorG" value="149"/>
    <property key="labeling/shapeFillColorR" value="1"/>
    ...
    <property key="labeling/xOffset" value="-2"/>
  ...
  <displayfield>level_name</displayfield>
  <label>0</label>
  <labelattributes>
    <label fieldname="" text="Label"/>
    <family fieldname="" name="AvantGarde Bk BT"/>
  ...
  <aliases>
    <alias field="parent_name" index="0" name=""/>
    <alias field="area_id" index="1" name=""/>
    <alias field="last_updated" index="2" name=""/>
    <alias field="area_name" index="3" name=""/>
    <alias field="geom_id" index="4" name=""/>
    <alias field="state" index="5" name=""/>
    <alias field="city_name" index="6" name=""/>
  </aliases>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      <column width="-1" hidden="0" type="field" name="parent_name"/>
      <column width="-1" hidden="0" type="field" name="area_id"/>
      <column width="-1" hidden="0" type="field" name="last_updated"/>
      <column width="-1" hidden="0" type="field" name="area_name"/>
      <column width="-1" hidden="0" type="field" name="geom_id"/>
      <column width="-1" hidden="0" type="field" name="state"/>
      <column width="-1" hidden="0" type="field" name="city_name"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    <default field="parent_name" expression=""/>
    <default field="area_id" expression=""/>
    <default field="last_updated" expression=""/>
    <default field="area_name" expression=""/>
    <default field="geom_id" expression=""/>
    <default field="state" expression=""/>
    <default field="city_name" expression=""/>
  </defaults>
