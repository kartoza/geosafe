...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Analysis.task_state'
        db.add_column(u'geosafe_analysis', 'task_state',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Analysis.task_state'
        db.delete_column(u'geosafe_analysis', 'task_state')
    ...
    models = {
        ...
        u'geosafe.analysis': {
            ...
            'extent_option': ('django.db.models.fields.IntegerField', [], {'default': '2'}),
            ...
            'impact_layer': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'impact_layer'", 'null': 'True', 'to': u"orm['layers.Layer']"}),
            'keep': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'report_map': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'report_table': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'task_id': ('django.db.models.fields.CharField', [], {'max_length': '40', 'null': 'True', 'blank': 'True'}),
            'task_state': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['people.Profile']", 'null': 'True', 'blank': 'True'})
        },
        u'geosafe.metadata': {
            'Meta': {'object_name': 'Metadata'},
            'category': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '30', 'null': 'True', 'blank': 'True'}),
            'layer': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'metadata'", 'unique': 'True', 'primary_key': 'True', 'to': u"orm['layers.Layer']"}),
